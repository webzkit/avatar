...
# from core.event.producer import ProducerEvent
...
# AVATAR_SERVICE_TOPIC = "avatar_service"
...
def consume_kafka():
    ...
    kafka_consumer = ConsumerEvent(AVATAR_SERVICE_TOPIC, loop)
...
async def root() -> Any:
    ...
    # producer = ProducerEvent(USER_SERVICE_TOPIC)
